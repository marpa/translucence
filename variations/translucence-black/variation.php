...
if ($translucence_options['background'] == "translucence-black") {

	$translucence_options['background_image_directory'] = "translucence-black";
	$translucence_options['background_image_file'] = "none";
...
// 	$translucence_options['site-description-color'] = "#FFFFFF";
	...
	$translucence_options['background_color'] = "#0F0F0F";
	$translucence_options['foreground_color'] = "#000000";	
...
// 	$translucence_options['post-text-shadow-color'] = "#333333";
	...
	if ($translucence_options['variation-type'] == "default") {	
		...
		$translucence_options['site-title-color'] = "#EBD336";
		$translucence_options['site-description-color'] = "#CCCCCC";
