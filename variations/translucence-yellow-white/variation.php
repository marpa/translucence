...
if ($translucence_options['background'] == "translucence-yellow-white") {

	$translucence_options['background_image_file'] = "bg_topdark.jpg";
	$translucence_options['background_image_directory'] = "translucence-yellow-white";	
