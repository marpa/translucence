...
if ($options['background'] == "translucence-dark-gray") {
	...
	$options['background_color'] = "#666666";
...
// 	$options['post-text-shadow-color'] = "#333333";
	...
	if (!in_array($options['top-color'], array_values($translucence_options_values['sidebar-color']))) $options['top-color'] = "#262626";
	if (!in_array($options['content-color'], array_values($translucence_options_values['sidebar-color']))) $options['content-color'] = "#262626";
	if (!in_array($options['bottom-color'], array_values($translucence_options_values['sidebar-color']))) $options['bottom-color'] = "#262626";
