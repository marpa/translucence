...
.headerblock {
	...
	border-top: 1px <?php print $options['header-hover-border-style']?> #FFFFFF;
...
#tertiary {
	...
	border-left: 1px <?php print $options['left01-border-style']?> #FFFFFF;
...
#tertiary:hover {
	...
	border-left: 1px <?php print $options['left01-hover-border-style']?> #FFFFFF;
...
#primary {
	...
	border-right: 1px <?php print $options['right01-border-style']?> #FFFFFF;
...
#secondary {
	...
	border-right: 1px <?php print $options['right02-border-style']?> #FFFFFF;
...
#secondary:hover {
	...
	border-right: 1px <?php print $options['right02-hover-border-style']?> #FFFFFF;
}
...
div.menu li {
	float: left;
	position: relative;
	box-shadow: 0px 0px 0px <?php print $options['header-text-shadow-color']?>;
	-moz-box-shadow: 0px 0px 0px <?php print $options['header-text-shadow-color']?>;
	-webkit-box-shadow: 0px 0px 0px <?php print $options['header-text-shadow-color']?>;	
}
...
#access ul ul:hover > a {
	...
	box-shadow: 0px 0px 1px <?php print $options['header-text-shadow-color']?>;
	-moz-box-shadow: 0px 0px 1px <?php print $options['header-text-shadow-color']?>;
	-webkit-box-shadow: 0px 0px 1px <?php print $options['header-text-shadow-color']?>;	
	
	border-top: 1px solid transparent;
	border-bottom: 1px solid <?php print $options['top-border-bottom']?>;	
	border-left: 1px <?php print $options['top-border-style']?> <?php print $options['top-border-left']?>;
	border-right: 1px <?php print $options['top-border-style']?> <?php print $options['top-border-right']?>;
	text-decoration: none;	
}
