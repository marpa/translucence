...
$translucence_config['theme-name'] = "2010 Translucence Minimal";
...
$translucence_config['background'] = "translucence-white";
...
$translucence_config['right01-color'] = "#FFFFFF";
$translucence_config['right02-color'] = "#FFFFFF";
$translucence_config['bottom-color'] = "#FFFFFF";

$translucence_config['site-opacity'] = "0";
$translucence_config['title-box-opacity'] = ".0";
$translucence_config['description-box-opacity'] = ".0";

$translucence_config['header-opacity'] = "0";
$translucence_config['top-opacity'] = "0";
$translucence_config['left01-opacity'] = "0";
$translucence_config['content-opacity'] = "0";
$translucence_config['right01-opacity'] = "0";
$translucence_config['right02-opacity'] = "0";
$translucence_config['bottom-opacity'] = "0";

$translucence_config['site-border-style'] = "none";
$translucence_config['header-border-style'] = "solid";
$translucence_config['top-border-style'] = "none";
$translucence_config['content-border-style'] = "none";
...
$translucence_config['variations_disabled'][] = 'translucence-draft';
